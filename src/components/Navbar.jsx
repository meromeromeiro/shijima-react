...
function Navbar({ onToggleOffCanvas, title }) {
  return (
    ...
    >
      ...
      {/* Right section (placeholder for balance or future icons) */}
      <div className="w-10"> {/* Or match width of hamburger button container if needed for perfect centering */}
        {/* e.g., <button className="p-2"><SearchIcon /></button> */}
      </div>
    </nav>
  );
}
